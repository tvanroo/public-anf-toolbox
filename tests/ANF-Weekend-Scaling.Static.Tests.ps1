...
Assert-Contains -Haystack $scriptText -Needle 'Manual QoS pools are moved as Manual QoS pools' -Message 'Expected script to document Manual QoS support.'
Assert-Contains -Haystack $scriptText -Needle 'function Get-AnfManualMimicAutoPlan' -Message 'Expected Manual QoS mimic-auto allocation helper.'
...
Assert-Contains -Haystack $readmeText -Needle 'Auto QoS pools are moved without per-volume throughput changes' -Message 'Expected README to document Auto QoS behavior.'
Assert-Contains -Haystack $readmeText -Needle 'Manual QoS pools are moved as Manual QoS pools' -Message 'Expected README to document Manual QoS behavior.'
Assert-Contains -Haystack $readmeText -Needle '1 MiB/s per-volume floor' -Message 'Expected README to document Manual QoS throughput floor.'
